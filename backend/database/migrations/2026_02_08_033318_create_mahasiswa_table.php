...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('mahasiswa', function (Blueprint $table) {
            ...
            $table->enum('tahap_ta', ['pendaftaran', 'proposal', 'uji_kelayakan_1', 'tes_tahap_1', 'uji_kelayakan_2', 'tes_tahap_2', 'pergelaran', 'sidang_skripsi', 'sidang_komprehensif', 'gugur'])->nullable()->index('idx_tahap_ta');
